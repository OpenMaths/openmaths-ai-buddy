        ...
        <div className="flex-1 flex flex-col py-6 px-4">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 py-0">
              <main className="flex-1 flex flex-col rounded-2xl shadow-xl bg-card transform translate-y-[-4px] my-0 py-[345px]">
                {messages.length === 0 ? (/* Welcome/Search State */
              <div className="flex-1 flex flex-col items-center justify-center p-8 relative px-0 mx-0 py-[345px] my-0">
